        ...
        <div class="steps-column">
          ...
          <section class="glass-card step-card" :class="{ 'step-active': currentStep === 1 }">
            ...
            <div class="step-content">
              ...
              <div class="note-box" style="margin: 0.75rem 0 1rem 0; padding: 0.75rem 1rem; border-radius: 6px; background: rgba(234, 179, 8, 0.08); border: 1px solid rgba(234, 179, 8, 0.2); font-size: 0.825rem; color: #fbbf24; line-height: 1.4; display: flex; gap: 0.5rem; align-items: flex-start;">
                <AlertTriangle size="16" style="margin-top: 0.1rem; flex-shrink: 0;" />
                <div>
                  <strong>Architectural Warning:</strong> In a real project, keys are generated strictly in your local command-line terminal using the <code>age-keygen</code> CLI tool. Private keys are never generated by a backend server or sent over the network to the browser. This UI simulator is for visual learning only.
                </div>
              </div>
          ...
          <section class="glass-card step-card" :class="{ 'step-active': currentStep === 3, 'step-disabled': currentStep < 3 }">
            ...
            <div class="step-content">
              ...
              <div class="note-box" style="margin: 0.75rem 0 1rem 0; padding: 0.75rem 1rem; border-radius: 6px; background: rgba(234, 179, 8, 0.08); border: 1px solid rgba(234, 179, 8, 0.2); font-size: 0.825rem; color: #fbbf24; line-height: 1.4; display: flex; gap: 0.5rem; align-items: flex-start;">
                <AlertTriangle size="16" style="margin-top: 0.1rem; flex-shrink: 0;" />
                <div>
                  <strong>Architectural Warning:</strong> In real development, the encryption of secrets is run locally in your terminal before committing the file to git. This backend endpoint is only simulated here for the interactive demo.
                </div>
              </div>
          ...
          <section class="glass-card step-card" :class="{ 'step-active': currentStep === 4, 'step-disabled': !encryptedSecrets }">
            ...
            <div class="step-content">
              ...
              <div class="note-box" style="margin: 0.75rem 0 1rem 0; padding: 0.75rem 1rem; border-radius: 6px; background: rgba(234, 179, 8, 0.08); border: 1px solid rgba(234, 179, 8, 0.2); font-size: 0.825rem; color: #fbbf24; line-height: 1.4; display: flex; gap: 0.5rem; align-items: flex-start;">
                <AlertTriangle size="16" style="margin-top: 0.1rem; flex-shrink: 0;" />
                <div>
                  <strong>Architectural Warning:</strong> In production deployments, you never upload or transmit the private key via a web API. Instead, you save the private key as a secure environment variable (<code>SOPS_AGE_KEY</code>) in your hosting dashboard (e.g. Vercel dashboard).
                </div>
              </div>
